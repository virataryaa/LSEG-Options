"""
SB Options Ingest — LSEG (interim migration)
================================================
LSEG-API replacement for ICEBREAKER/Options/Code/SB_Ingest.py (icepython-based).

RIC scheme confirmed live via discovery.search: 1SB<strike*100><month_code><2-
digit year>, e.g. 1SB1600J26 = SB Oct 2026 16.00 Call. Same *100-cents
encoding as KC, grid step 0.25 cts/lb (matches ICE's own 0.25 cts/lb strike
step exactly).
